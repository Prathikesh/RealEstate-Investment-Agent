"""
Laval mill rate scraper.

Source: https://www.laval.ca/Pages/Fr/Citoyens/taxes-et-evaluations.aspx
"""
import json
import re
...
SOURCE_URL = "https://www.laval.ca/Pages/Fr/Citoyens/taxes-et-evaluations.aspx"
SOURCE_LAW = "Charte de la Ville de Laval, RLRQ c C-11.3"

FALLBACK = {
    "mill_rate_per_1000": "7.8400",
    "unit": "per_1000",
    "year": 2025,
...
class LavalScraper(BaseScrapFlyScraper):
