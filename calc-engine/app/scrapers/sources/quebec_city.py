"""
Quebec City mill rate scraper.

Source: https://www.ville.quebec.qc.ca/citoyens/taxes/taux.aspx
"""
import json
import re
...
SOURCE_URL = "https://www.ville.quebec.qc.ca/citoyens/taxes/taux.aspx"
SOURCE_LAW = "Charte de la Ville de Québec, RLRQ c C-11.5"

FALLBACK = {
    "mill_rate_per_1000": "8.2700",
    "unit": "per_1000",
    "year": 2025,
...
class QuebecCityScraper(BaseScrapFlyScraper):
